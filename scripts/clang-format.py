...
import pynvim
from pynvim.api.nvim import Nvim as vim
...
def main():
  ...
  if vim.eval('exists("l:lines")', async_=False) == '1':
    lines = ['-lines', vim.eval('l:lines')]
  elif vim.eval('exists("l:formatdiff")', async_=False) == '1':
  ...
  cursor = int(vim.eval('line2byte(line("."))+col(".")', async_=False)) - 2
  if cursor < 0:
